        ...
        try
        {
            ...
            while(true)
            {
                ...
                if (command.equals("REG")) {
                    ...
                    System.out.println("BootstrapServer|reply: "+reply);
                    System.out.println("BootstrapServer|incoming.getAddress(): "+incoming.getAddress());
                    System.out.println("BootstrapServer|incoming.getPort(): "+incoming.getPort());
                    sock.send(dpReply);
